...
func (ec *executionContext) _Query_organization(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOOrganization2ᚖgithubᚗcomᚋaerealᚋgithubᚑgraphqlᚑproxyᚋgraphᚋdtoᚐOrganization(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOOrganization2ᚖgithubᚗcomᚋaerealᚋgithubᚑgraphqlᚑproxyᚋgraphᚋdtoᚐOrganization(ctx context.Context, sel ast.SelectionSet, v *dto.Organization) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
